...
- ✅ **Продвинутые фильтры** (подписка, баланс, дата) (NEW)
- ✅ **Детальная страница пользователя** с графиками (NEW)
- ✅ **Экспорт в CSV** (NEW)
- ✅ Информация о балансе и реферальных кодах
- ✅ Real-time данные через SWR

### 🖥️ Servers (Серверы)
- ✅ Мониторинг всех серверов
- ✅ **Детальная страница сервера** с графиками (NEW)
- ✅ **График нагрузки за 24 часа** (NEW)
- ✅ **История uptime** (NEW)
